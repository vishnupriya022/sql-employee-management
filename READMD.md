...
📸(screenshots/Active employee list.png)
...
📸(screenshots/employee with department & role (JOIN).png)
...
📸(screenshots/department-wise salary report.png)
...
📸(screenshots/department with salary  60000 (HAVING).png)
